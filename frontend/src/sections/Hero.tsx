          ...
          >
            ...
            >
              <button
                ...
                className="bg-mono-primary hover:bg-mono-primary-dark text-white rounded-full px-8 py-4 text-lg font-medium shadow-mono hover:shadow-mono-lg transition-all duration-300 transform hover:scale-105 flex items-center gap-2 group"
              >
                立即开始
              ...
              <button
                ...
                className="rounded-full px-8 py-4 text-lg font-medium border-2 border-mono-border hover:border-mono-primary hover:text-mono-primary transition-all duration-300"
              >
                了解更多
              </button>
            </div>
